...
var SS_PATCH = {
    ...
    Venusaur: { bs: { sa: 110 },
        otherFormes: ['Venusaur-Gmax', 'Venusaur-Mega'] },
    Voodoom: { bs: { sa: 130 } },
...
var LP = (0, util_1.extend)(true, {}, SS, PLA_PATCH);
var SV_PATCH = {
    ...
    Dewgong: { bs: { at: 80, sa: 80 } },
    'Farfetch\u2019d': { types: ['Fighting', 'Flying'], bs: { hp: 55, at: 110, df: 90, sa: 55, sd: 60, sp: 110 } },
    Fearow: { bs: { at: 110 } },
    Flareon: { bs: { hp: 110, sa: 65, sd: 65, sp: 95 } },
    Goldeen: { bs: { at: 55, df: 55, sa: 62, sd: 40, sp: 73 } },
    Golduck: { types: ['Water', 'Psychic'] },
    Jigglypuff: { bs: { at: 55, df: 30, sa: 55, sd: 35, sp: 30 }, abilities: { 0: 'Magic Guard' } },
    Jynx: { bs: { hp: 75, at: 40, sa: 125 } },
    Mankey: { bs: { sd: 35, sp: 80 } },
    'Mr. Mime': { bs: { hp: 50, at: 35, sa: 110, sp: 95 } },
    Nidoking: { bs: { sa: 90 } },
    Nidoqueen: { bs: { sp: 81 } },
    Onix: { bs: { at: 75, sp: 80 } },
    Parasect: { bs: { at: 115, df: 100, sa: 55, sd: 90 } },
    Persian: { bs: { at: 80, sa: 80 } },
    ...
    Granbull: { bs: { sd: 75 } },
    Hoppip: { bs: { sa: 45 } },
    Houndoom: { bs: { at: 100 }, abilities: { 0: 'Intimidate' } },
    Houndour: { abilities: { 0: 'Intimidate' } },
    Igglybuff: { abilities: { 0: 'Magic Guard' } },
    Jumpluff: { bs: { sa: 85 } },
    Lanturn: { bs: { df: 70 } },
    Ledian: {
        types: ['Bug', 'Fighting'],
        bs: { hp: 65, at: 105, df: 50, sa: 35 },
        abilities: { 0: 'Technician' }
    },
    Ledyba: {
        types: ['Bug', 'Fighting'],
    ...
    Magcargo: { bs: { df: 150, sa: 110, sd: 100 } },
    Mantine: { bs: { sa: 90 } },
    Marill: { bs: { sa: 40 } },
    Meganium: {
        types: ['Grass', 'Fairy'],
    ...
    Noctowl: { types: ['Psychic', 'Flying'], bs: { at: 40, sa: 106, sd: 116, sp: 60 } },
    Quagsire: { bs: { at: 95, df: 95 } },
    Qwilfish: { bs: { at: 95, df: 95, sa: 45, sd: 65, sp: 95 } },
    Sentret: { bs: { hp: 45, at: 45, df: 35, sp: 40 } },
    Skiploom: { bs: { sa: 65 } },
    Slugma: { bs: { hp: 50, at: 50, df: 50, sa: 90, sd: 50 } },
    Smoochum: { bs: { sa: 95 } },
    Spinarak: { bs: { at: 70, sp: 45 } },
    Stantler: { bs: { at: 105, sa: 75 } },
    Steelix: { bs: { at: 105, sa: 45 } },
    Sudowoodo: { bs: { hp: 90, at: 115, df: 125, sd: 75 } },
    Sunflora: { bs: { hp: 85, at: 55, df: 85, sa: 125, sd: 95 } },
    ...
    Xatu: { bs: { hp: 80 } },
    Absol: { bs: { hp: 75, sa: 85, sp: 90 } },
    Aggron: { types: ['Steel'] },
    Armaldo: { bs: { sp: 50 } },
    Aron: { types: ['Steel'] },
    Azurill: { bs: { sa: 40 } },
    Banette: { types: ['Ghost', 'Normal'], bs: { at: 125, sa: 93, sp: 70 } },
    Beautifly: { bs: { hp: 60, at: 70, df: 60, sa: 125, sd: 60, sp: 75 } },
    Blaziken: { bs: { df: 75 } },
    Castform: { bs: { hp: 60, at: 60, df: 60, sa: 105, sd: 70, sp: 95 } },
    'Castform-Rainy': { bs: { hp: 60, at: 60, df: 60, sa: 105, sd: 70, sp: 95 } },
    'Castform-Snowy': { bs: { hp: 60, at: 60, df: 60, sa: 105, sd: 70, sp: 95 } },
    'Castform-Sunny': { bs: { hp: 60, at: 60, df: 60, sa: 105, sd: 70, sp: 95 } },
    Chimecho: { bs: { at: 40, sa: 110, sd: 100 } },
    Cradily: { bs: { sa: 86 } },
    Crawdaunt: { bs: { sp: 67 } },
    Delcatty: { bs: { at: 75, df: 80, sa: 75, sd: 80, sp: 95 } },
    Flygon: { types: ['Bug', 'Dragon'], bs: { hp: 90, at: 110, df: 85, sa: 130, sd: 85 } },
    Glalie: {
        types: ['Ice', 'Rock'],
        bs: { at: 110, df: 110, sa: 60, sd: 60, sp: 80 },
        abilities: { 0: 'Levitate' }
    },
    Huntail: { bs: { at: 94, sa: 75, sd: 104 } },
    Illumise: { types: ['Bug', 'Fairy'], bs: { at: 33, df: 85, sa: 97, sp: 100 } },
    Kecleon: { bs: { at: 100 } },
    Kirlia: { bs: { sa: 95, sd: 85 } },
    Lairon: { types: ['Steel'] },
    Linoone: { bs: { hp: 85, at: 85, df: 70, sd: 70, sp: 110 } },
    Lunatone: { bs: { sa: 100 } },
    Luvdisc: { types: ['Water', 'Fairy'], bs: { hp: 50, df: 75, sa: 95, sd: 75, sp: 125 } },
    Masquerain: { types: ['Bug', 'Water'], bs: { at: 50, df: 50, sa: 110, sd: 100, sp: 100 } },
    Mawile: {
        bs: { hp: 60, at: 95, df: 115, sd: 85 },
        weightkg: 11.5,
        abilities: { 0: 'Huge Power' }
    },
    Medicham: { bs: { df: 80, sa: 80, sd: 80, sp: 90 } },
    Meditite: { bs: { sa: 60 } },
    Mightyena: { bs: { at: 110, sp: 100 } },
    Milotic: { types: ['Water', 'Fairy'] },
    Minun: { bs: { at: 85, sa: 50, sd: 95, sp: 110 } },
    Nosepass: { bs: { at: 35, sa: 55 } },
    Pelipper: { bs: { df: 110, sd: 80 } },
    Plusle: { bs: { df: 50, sa: 95, sd: 85, sp: 110 } },
    Poochyena: { bs: { at: 75, sp: 65 } },
    Ralts: { bs: { sa: 65, sd: 55 } },
    Sableye: { bs: { hp: 60, df: 100, sa: 75, sd: 100 }, abilities: { 0: 'Magic Bounce' } },
    Sceptile: {
        types: ['Grass', 'Dragon'],
        bs: { at: 95, sd: 80 },
        abilities: { 0: 'Unburden' }
    },
    Seviper: { types: ['Poison', 'Dark'], bs: { hp: 75, at: 115, sa: 80, sp: 80 } },
    Shroomish: { abilities: { 0: 'Technician' } },
    Skitty: { bs: { at: 50, df: 50, sa: 40, sd: 40, sp: 60 } },
    Solrock: { bs: { at: 100 } },
    Surskit: { bs: { df: 30, sa: 55, sd: 55 } },
    Swablu: { types: ['Fairy', 'Flying'] },
    Swellow: { bs: { at: 90, sa: 80 } },
    Trapinch: { types: ['Bug', 'Ground'], bs: { hp: 55 } },
    Tropius: { bs: { hp: 110, at: 95, df: 95, sa: 95, sd: 95, sp: 45 } },
    Vibrava: { types: ['Bug', 'Dragon'], bs: { hp: 60, at: 80, df: 55, sa: 90, sd: 55 } },
    Volbeat: {
        types: ['Bug', 'Electric'],
        bs: { at: 33, sa: 107, sp: 100 },
        abilities: { 0: 'Swarm' }
    },
    Zangoose: { bs: { hp: 75, sp: 100 } },
    Zigzagoon: { bs: { at: 40 } },
    Ambipom: { bs: { sa: 90 } },
    Azelf: { types: ['Psychic', 'Fairy'] },
    Bastiodon: { bs: { at: 27, sa: 77 } },
    Bibarel: { bs: { hp: 94, at: 100, df: 65, sd: 65 } },
    Bonsly: { bs: { hp: 60, at: 85, sd: 55 } },
    Bronzong: { bs: { hp: 69 } },
    Burmy: { bs: { at: 20, sa: 45, sp: 30 } },
    Carnivine: { types: ['Grass', 'Steel'], bs: { at: 110, sa: 100, sp: 36 } },
    Chatot: { bs: { hp: 75, at: 45, df: 55, sa: 110, sd: 55, sp: 110 }, abilities: { 0: 'Soundproof' } },
    Cherrim: { bs: { at: 45, sa: 107, sd: 83, sp: 90 } },
    'Cherrim-Sunshine': { types: ['Grass', 'Fire'], bs: { at: 45, sa: 107, sd: 83, sp: 90 } },
    Chingling: { bs: { sa: 80, sd: 60 } },
    Drapion: { bs: { sd: 85 } },
    Drifblim: { bs: { df: 54 } },
    ...
    Gastrodon: { otherFormes: ['Gastrodon-East'] },
    'Gastrodon-East': {
        types: ['Water'],
        bs: { hp: 111, at: 83, df: 82, sa: 92, sd: 68, sp: 39 },
        weightkg: 6.3,
        nfe: true,
        abilities: { 0: 'Damp' },
    ...
    Kricketune: { bs: { hp: 80, at: 115, df: 70, sa: 40, sd: 70, sp: 75 } },
    Lickilicky: { bs: { at: 100 }, abilities: { 0: 'Oblivious' } },
    Lopunny: { types: ['Normal', 'Fighting'], bs: { at: 106, sa: 44 }, abilities: { 0: 'Scrappy' } },
    Lumineon: { bs: { hp: 70, at: 40, df: 75, sa: 105, sd: 90, sp: 105 } },
    Luxray: { types: ['Electric', 'Dark'], abilities: { 0: 'Intimidate' } },
    ...
    Purugly: { bs: { hp: 90, at: 95, df: 70, sa: 80, sd: 60, sp: 115 } },
    Regigigas: { abilities: { 0: 'Friend Guard' } },
    Rampardos: { bs: { hp: 97, at: 155, df: 90, sa: 35, sd: 90, sp: 33 } },
    Rotom: { bs: { sp: 101 } },
    'Rotom-Fan': { abilities: { 0: 'Motor Drive' } },
    Stunky: { bs: { hp: 65, at: 65, df: 50, sa: 40, sd: 40, sp: 75 } },
    Skuntank: { bs: { hp: 115, at: 95, df: 70, sa: 85, sd: 60, sp: 85 } },
    Shellos: { otherFormes: ['Shellos-East'] },
    'Shellos-East': {
        types: ['Water'],
        bs: { hp: 76, at: 48, df: 62, sa: 57, sd: 48, sp: 34 },
        weightkg: 6.3,
        nfe: true,
        abilities: { 0: 'Damp' },
    ...
    Toxicroak: { bs: { sp: 98 } },
    Torterra: { bs: { at: 114, df: 110 } },
    Uxie: { types: ['Psychic', 'Fairy'] },
    Vespiquen: { bs: { hp: 96 } },
    Wormadam: { bs: { hp: 60, at: 50, df: 90, sa: 110, sd: 110, sp: 30 } },
...
exports.SPECIES = [{}, RBY, GSC, ADV, DPP, BW, XY, SM, SS, SV, LP];
